...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query(value = "WITH RECURSIVE category_hierarchy AS ( " +
            ...
            "      (:categoryName IS NULL OR cat.category_id IN (SELECT category_id FROM category_hierarchy)) " +
            "ORDER BY " +
            "   CASE WHEN :sortField IS NOT NULL AND :sortField = 'price' AND :sortDirection = 'ascending' THEN product.price end, " +
            "   CASE WHEN :sortField IS NOT NULL AND :sortField = 'price' AND :sortDirection = 'descending' THEN product.price end desc, " +
            "   CASE WHEN :sortField IS NOT NULL AND :sortField = 'productName' AND :sortDirection = 'ascending' THEN product.product_name end, " +
            "   CASE WHEN :sortField IS NOT NULL AND :sortField = 'productName' AND :sortDirection = 'descending' THEN product.product_name end desc, " +
            "   CASE WHEN :sortField IS NOT NULL AND :sortField = 'createdAt' AND :sortDirection = 'ascending' THEN product.created_at end, " +
            "   CASE WHEN :sortField IS NOT NULL AND :sortField = 'createdAt' AND :sortDirection = 'descending' THEN product.created_at end desc"
            , nativeQuery = true)
    List<Map<String, Object>> getProductsByUserId(
